...
const alicloudConfigAggregateDeliveries = `{
  "block": {
    "attributes": {
      "aggregator_id": {
...
func AlicloudConfigAggregateDeliveriesSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(alicloudConfigAggregateDeliveries), &result)
	return &result
}
